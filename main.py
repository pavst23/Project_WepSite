                          ...
                          <body>
                            ...
                            <div class="alert alert-danger" role="alert">
                                <form class="login_form" method="post">
                                    ...
                                    <input type="place" class="form-control" id="place" placeholder="Укажите удобное для вас место проведения мероприятия" name="place">
                                    <div class="form-group">
                                  ...
                                  <body>
                                    ...
                                    <div class="alert alert-primary" role="alert">
                                        ...
                                        <form class="login_form" method="post">
                                            ...
                                            <h2>Организатры мероприятия свяжутся с Вами в ближайшее время!</h2>
